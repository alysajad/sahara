...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    // We observe a slight delay to ensure the component is rendered completely
  ...
  useEffect(() => {
    if (animateOn === 'click') {
      ...
      // make sure it starts encrypted if animating on view
      encryptInstantly(); 
    } else {
      setDisplayText(text);
      setIsDecrypted(true);
    ...
    setRevealedIndices(new Set());
    setDirection('forward');
  }, [animateOn, text, encryptInstantly, hasAnimated]);
